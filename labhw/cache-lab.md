...
1.  For this lab, you will need to answer several questions about *set-associative* caches. Normally, we would have consistently covered this in lecture before the lab,
    but we had some disruptions last week, so there's some description below. You can also find this topic covered in the 26 Feb lecture 9am recording from 24:20 through around 55:00.
