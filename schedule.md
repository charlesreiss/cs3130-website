...
{%- capture file_prefix_9 -%}{{ day.date | date: "%Y%m%d-9am" }}{%- endcapture -%}
...
{%- assign video_raw_9 = site.data.recordings | where:"prefix",file_prefix_9-%}
{%- if video_raw.size > 0 -%}
    {%- assign video = true %}
{%- else -%}
    {%- assign video = false %}
...
{%- endif -%}
{%- if video_raw_9.size > 0 -%}
    {%- assign video_9 = true %}
{%- else -%}
    {%- assign video_9 = false %}
{%- endif -%}
...
{%- endif -%}
{%- if video -%}
      | screencapture (<a href="/~cr4bd/videoplayer/?3130/S2025/recordings/{{ file_prefix }}-video-and-audio">browser</a>&nbsp; or download <a href="recordings/{{ file_prefix }}-video-and-audio.mp4">mp4</a> <a href="recordings/{{ file_prefix }}-video-and-audio.webm">webm</a> <a href="recordings//{{ file_prefix }}-audio.mp3">audio</a>
    )
{%- endif -%}
{%- if video_9 -%}
      | 9:30am screencapture (<a href="/~cr4bd/videoplayer/?3130/S2025/recordings/{{ file_prefix_9 }}-video-and-audio">browser</a>&nbsp; or download <a href="recordings/{{ file_prefix_9 }}-video-and-audio.mp4">mp4</a> <a href="recordings/{{ file_prefix_9 }}-video-and-audio.webm">webm</a> <a href="recordings//{{ file_prefix_9 }}-audio.mp3">audio</a>
    )
{%- endif -%}
{%- if video_12 -%}
      | 12:30pm screencapture (<a href="/~cr4bd/videoplayer/?3130/S2025/recordings/{{ file_prefix_12 }}-video-and-audio">browser</a>&nbsp; or download <a href="recordings/{{ file_prefix_12 }}-video-and-audio.mp4">mp4</a> <a href="recordings/{{ file_prefix_12 }}-video-and-audio.webm">webm</a> <a href="recordings//{{ file_prefix_12 }}-audio.mp3">audio</a>
    )
{%- endif -%}
