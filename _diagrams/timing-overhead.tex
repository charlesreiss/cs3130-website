...
\fill[yellow!80!black] (2.1, 0) rectangle ++(5.5, 1);
...
%\draw (2.35, -0.1) -- ++(0, -0.5)
%j    node[below,font=\tt\fontsize{7}{8}\selectfont]{call getppid};
\draw[black,very thick,decorate,decoration={brace, mirror}] (2.1, -.05) -- ++(5.5, 0)
...
\draw[Latex-Latex] (2.1, 2.0) -- (7.6, 2.0) node[above,midway] {what you want to measure};
