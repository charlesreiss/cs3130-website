...
that script needs work
    ...
    7. Discuss some examples of "it's powerful if you know how to use it," such as bad or missing documentation, idiosyncratic user interfaces, etc.
        ...
        <div class="note">
I do not have a good example here. I tried getfacl/setfacl vs chmod but it did not go over well. I tried showing some of the tools I created for class with incomplete UI, but the overhead was to great.
